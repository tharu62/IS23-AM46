...
import it.polimi.ingsw.SetUpper;
...
public class ClientAPP {
    ...
    public static void main(String[] args){
        ...
        //VIEW gui = null;
        do {
            System.out.print("Select what you want to start (SetUpper or VIEW): ");
            Scanner in = new Scanner(System.in);
            input = in.next();
            input = input.toUpperCase();
            if (input.equals("SetUpper")) {
                cli = new SetUpper();
        ...
        } while (!input.equals("SetUpper") && !input.equals("RMI"));
